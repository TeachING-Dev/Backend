...
public enum MaterialSuccessCode implements BaseSuccessCode {
    ...
    MATERIAL_ANALYSIS_DETAIL_UPDATE_SUCCESS(HttpStatus.OK, "ANALYSIS2104", "AI 상세 분석이 수정되었습니다."),
    ...
    MATERIAL_URL_ANALYSIS_READY(HttpStatus.OK, "ANALYSIS2103", "URL 분석 요청 검증에 성공했습니다."),
