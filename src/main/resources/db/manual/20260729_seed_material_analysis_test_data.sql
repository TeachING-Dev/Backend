...
--
-- Prerequisite: assumes the '휘윤' user already has the '백엔드 개발' / 'iOS 개발' folders
-- and their 12 materials (6 each), as created by the earlier folder/material seed script.
-- This script only adds the analysis layer on top of those existing materials:
--   materials.ai_status -> COMPLETED
--   + material_analysis (1:1, summary/detail_analysis per material)
--   + material_highlights (MAIN + CAUTION per analysis)
--   + tag / material_tag (a topic tag + a folder-level tag per material)
--
...
-- =====================================================
-- 0. 대상 자료들을 COMPLETED 상태로 전환 (분석 데이터가 실제로 붙으므로)
-- =====================================================
...
-- =====================================================
-- 1. material_analysis 생성 (자료 1건당 1건, 제목으로 매칭)
-- =====================================================
...
-- =====================================================
-- 2. material_highlights 생성 (분석 1건당 MAIN 1개 + CAUTION 1개)
-- =====================================================
...
-- =====================================================
-- 3. tag 생성 (폴더별 공통 태그 + 자료별 주제 태그, 이름 중복 없이 한 번만 생성)
-- =====================================================
...
-- =====================================================
-- 4. material_tag 연결 (자료마다 주제 태그를 대표 태그로, 폴더 공통 태그를 보조 태그로)
-- =====================================================
